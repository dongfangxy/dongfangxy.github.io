...
围绕航天器姿态控制问题，进行了一系列研究，包括单体航天器控制，多航天器姿态协同控制，面向故障诊断的学习观测器(Learning Observer)设计，简单高效的在线学习控制(Oline-Learning Control)，面向姿态控制系统安全控制算法设计等。发表SCI论文30余篇，参见[研究成果](https://dongfangxy.github.io/publications/)、申请国防专利3项；主持国家自然科学基金1项。
